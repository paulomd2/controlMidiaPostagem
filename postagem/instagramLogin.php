...
$instagram = new Instagram(array(
    'apiKey' => '7ea5b03bc6db45efae2fbaf2375c6045',
    'apiSecret' => '0f3d2f7b5ad74661bbcdd1f82e152eec',
    'apiCallback' => 'http://www.agenciamd2.com.br/sites/contromidia/instagram/example/success.php' // must point to success.php
        ));
...
<html lang="en">
    <head>
        ...
        <script>
            function instagramLogin(url){
                window.location = url;
            }
        </script>
    </head>
    <body onload="instagramLogin('<?php echo $loginUrl; ?>')">
<!--        <pre>
            <?php
            var_dump($instagram);
            ?>
